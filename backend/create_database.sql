...
ALTER TABLE developer ADD column acc_id VARCHAR(100) DEFAULT NULL;
...
ADD COLUMN release_date DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN os VARCHAR(100) NULL,
ADD COLUMN processor VARCHAR(100) NULL,
ADD COLUMN memory VARCHAR(50) NULL,
ADD COLUMN storage VARCHAR(50) NULL;
